...
const (
	...
	GPT4_128k_1106 ChatGPTModel = "gpt-4-1106-preview"
)
...
func validate(req *ChatCompletionRequest) error {
	...
	allowedModels := []ChatGPTModel{
		GPT35Turbo, GPT35Turbo0301, GPT35Turbo0613, GPT35Turbo16k, GPT35Turbo16k0613, GPT4, GPT4_0314,
		GPT4_0613, GPT4_32k, GPT4_32k_0314, GPT4_32k_0613, GPT4_128k_1106,
	}
